...
**See Also:** [Display Rotation Master Guide](../../docs/DISPLAY_ROTATION_MASTER.md) - Complete mechanics of boot and X11 rotation
...
- `display_rotate=1` - Rotates boot framebuffer 90° clockwise (portrait → landscape)

**Boot Console Rotation (`/boot/firmware/cmdline.txt`):**
```bash
fbcon=rotate:1
```
- Rotates console text 90° clockwise to match framebuffer rotation

**See [Display Rotation Master Guide](../../docs/DISPLAY_ROTATION_MASTER.md) for complete mechanics.**
