#!/bin/bash
# PeppyMeter Screensaver - Working Version with Better Touch Detection
export DISPLAY=:0
...
# Monitor touch using evtest or xinput test (simpler approach)
monitor_touch() {
    ...
    # Use xinput test (simpler, more reliable)
    while true; do
        # Check for any touch event (button press, motion, etc.)
