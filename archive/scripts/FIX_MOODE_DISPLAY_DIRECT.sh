#!/bin/bash
# DIRECT VERSION - Führt Befehle direkt auf dem Pi aus (ohne sshpass)
# Für: Raspberry Pi 5, Waveshare 7.9" HDMI (1280x400 Landscape)

PI_IP="192.168.178.178"
PI_USER="andre"

echo "=== MOODE AUDIO DISPLAY FIX - DIRECT VERSION ==="
echo ""
echo "Diese Version erstellt SSH-Befehle, die du manuell ausführen kannst."
echo "Oder kopiere die Befehle und führe sie direkt auf dem Pi aus."
echo ""
echo "=== BEFEHLE FÜR PI ==="
echo ""
echo "1. Auf Pi einloggen:"
...
echo ""
echo "=== ALTERNATIVE: Script auf Pi speichern ==="
echo ""
echo "Kopiere die Befehle oben in eine Datei auf dem Pi:"
echo "  ssh $PI_USER@$PI_IP"
echo "  nano /tmp/fix_display.sh"
echo "  (Befehle einfügen)"
echo "  chmod +x /tmp/fix_display.sh"
echo "  bash /tmp/fix_display.sh"
echo "  sudo reboot"
echo ""
