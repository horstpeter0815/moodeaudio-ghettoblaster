...
3. Ethernet fix (`02-eth0-configure.service`) (safe access link, no default route)
4. iPhone USB tether fix (`iphone-usb-tether.service`)
5. Display fix (`.xinitrc`)
...
### Ethernet Fix
- `02-eth0-configure.service` - Configures static IP (192.168.10.2) as **management-only** (no default route)
